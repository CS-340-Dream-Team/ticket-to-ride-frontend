...
export class ServerProxyService {
	...
	public login(credentials: { username: string; password: string }): Promise<any> {
		return new Promise<any>((resolve, reject) => {
			this.http.post(`${environment.BASE_URL}/login`, credentials).subscribe(
				(res: Response) => {
	...
	public register(credentials: { username: string; password: string }): Promise<any> {
		...
		return new Promise<any>((resolve, reject) => {
			this.http.post(`${environment.BASE_URL}/register`, credentials).subscribe(
				(res: Response) => {
					const resJson = res.json();
					this._authToken = resJson.token;
					this._saveToLocalStorage(AUTH_TOKEN_STORAGE_KEY, this._authToken);
	...
	public getUpdatedGames(): Promise<Command[]> {
		return new Promise<any>((resolve, reject) => {
			this.http.get(`${environment.BASE_URL}/games`, this.generateHttpOptions()).subscribe(
				(res: Response) => {
					const resJson = res.json();
	...
	public joinGame(game: Game): Promise<Command[]> {
		...
		return new Promise<any>((resolve, reject) => {
			this.http.post(`${environment.BASE_URL}/` + url, {}, this.generateHttpOptions()).subscribe(
				(res: Response) => {
					const resJson = res.json();
					resolve([resJson.command]);
				},
	...
	public getGameData(lastCommandId: number): Promise<any> {
		...
		return new Promise<any>((resolve, reject) => {
			this.http.get(`${environment.BASE_URL}/${url}`, this.generateHttpOptions()).subscribe(
				(res: Response) => {
					const resJson = res.json();
	...
	public addMessage(chatInfo: { messageText: string; prevTimestamp: number }): Promise<any> {
		return new Promise<any>((resolve, reject) => {
			this.http
				.post(
					`${environment.BASE_URL}/chat/new/${chatInfo.prevTimestamp}`,
					chatInfo,
					this.generateHttpOptions()
				)
				.subscribe(
					(res: Response) => {
						const resJson = res.json();
	...
	public selectBusCard(index: number): Promise<Command[]> {
		return new Promise<any>((resolve, reject) => {
			this.http
				.post(`${environment.BASE_URL}/play/bus/${index}`, {}, this.generateHttpOptions())
				.subscribe(
					(res: Response) => {
						const resJson = res.json();
						resolve(resJson.commands);
	...
	public getSpread(): Promise<Command> {
		return new Promise<any>((resolve, reject) => {
			this.http.get(`${environment.BASE_URL}/play/bus`, this.generateHttpOptions()).subscribe(
				(res: Response) => {
					const resJson = res.json();
					resolve(resJson.command);
				},
	...
	public drawRoutes(): Promise<Command[]> {
		return new Promise<any>((resolve, reject) => {
			this.http.get(`${environment.BASE_URL}/play/routes`, this.generateHttpOptions()).subscribe(
				(res: Response) => {
					const resJson = res.json();
					resolve(resJson.command);
				},
	...
	public selectRoutes(selectedRoutes: Route[], rejectedRoutes: Route[]): Promise<Command[]> {
		return new Promise<any>((resolve, reject) => {
			this.http
				.post(
					`${environment.BASE_URL}/play/routes`,
	...
	public claimSegment(segment: Segment, cards: BusCard[]): Promise<Command[]> {
		...
		return this.http
			.post(url, { segmentId: segment.id, cards }, this.generateHttpOptions())
			.toPromise()
